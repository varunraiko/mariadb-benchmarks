...
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/nation.tbl' into table nation fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load nation table', now());

SELECT "loading table region.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/region.tbl' into table region fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load region table', now());

SELECT "loading table supplier.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/supplier.tbl' into table supplier fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load supplier table', now());

SELECT "loading table part.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/part.tbl' into table part fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load part table', now());

SELECT "loading table customer.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/customer.tbl' into table customer fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load customer table', now());

SELECT "loading table orders.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/orders.tbl' into table orders fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load orders table', now());

SELECT "loading table partsupp.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/partsupp.tbl' into table partsupp fields terminated by '|';
INSERT INTO time_statistics (task_name, timest) VALUES ('load partsupp table', now());

SELECT "loading table lineitem.tbl" AS progress;
LOAD DATA INFILE '/Users/varun/MariaDB/mariadb-benchmarks/dbt3new/work/lineitem.tbl' into table lineitem fields terminated by '|';
